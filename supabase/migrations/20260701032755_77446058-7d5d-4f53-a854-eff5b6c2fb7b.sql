CREATE OR REPLACE FUNCTION public.admin_set_payment_status(p_payment_id uuid, p_status text, p_plan_id uuid DEFAULT NULL::uuid, p_amount_usd numeric DEFAULT NULL::numeric)
 RETURNS payments
 LANGUAGE plpgsql
 SECURITY DEFINER
